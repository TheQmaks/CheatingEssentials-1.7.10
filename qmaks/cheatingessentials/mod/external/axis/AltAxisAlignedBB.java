...
public class AltAxisAlignedBB
{
    ...
    public AxisAlignedBB addCoord(double par1, double par3, double par5)
    {
        ...
        return getAABBPool().getBoundingBox(var7, var9, var11, var13, var15, var17);
    }
    ...
    public AxisAlignedBB func_111270_a(AltAxisAlignedBB par1AxisAlignedBB)
    {
        ...
        return getAABBPool().getBoundingBox(var2, var4, var6, var8, var10, var12);
    }
    ...
    {
        return getAABBPool().getBoundingBox(this.minX + par1, this.minY + par3, this.minZ + par5, this.maxX + par1, this.maxY + par3, this.maxZ + par5);
    }
    ...
    {
        return getAABBPool().getBoundingBox(this.minX, this.minY, this.minZ, this.maxX, this.maxY, this.maxZ);
    }
